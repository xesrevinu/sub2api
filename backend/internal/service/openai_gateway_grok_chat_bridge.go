...
func grokChatResponsesBridgeModel(model string) bool {
	...
	case "grok-4.5", "grok-4.6", "grok-4.6-latest", "grok-4.7", "grok-4.7-latest", "grok-4.7-beta":
		return true
	default:
		return false
	}
...
func (s *OpenAIGatewayService) forwardGrokChatCompletionsViaResponses(
	...
	responsesBody, err = applyGrokResponsesCacheIdentity(responsesBody, intentBody, cacheIdentity, grokFreeCacheInjectionEnabled(account))
	if err != nil {
