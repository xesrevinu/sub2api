...
const cnyToUSDFallbackExchangeRate = 0.145
...
func (s *BillingService) initFallbackPricing() {
	...
	// xAI Grok 4.7 is not on the public card yet; bill the same as Grok 4.6
	// ($2 / $0.50 cached / $6, 2x at ≥200k) so pre-release traffic is not $0.
...
func (s *BillingService) getFallbackPricing(model string) *ModelPricing {
	...
	case "grok-4.7", "grok-4.7-latest", "grok-4.7-beta":
