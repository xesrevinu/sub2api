...
func grokModelSupportsConfigurableReasoning(modelID string) bool {
	...
	case "grok-4.7", "grok-4.7-latest", "grok-4.7-beta", "grok-4.6", "grok-4.6-latest", "grok-4.5", "grok-4.5-latest", "grok", "grok-latest", "grok-build", "grok-build-latest", "grok-build-0.1":
		return true
	default:
		return false
	}
